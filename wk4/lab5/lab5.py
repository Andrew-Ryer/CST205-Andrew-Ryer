...
# 2 columns x 3 rows (width=2, height=3)
pixels = [
    [(54,54,54),     (232,22,93)],
    [(204,82,122),   (54,54,54)],
    [(71,71,71),     (168,167,167)]
]
...
# magnified preview
#img.resize((width*80, height*80), Image.NEAREST).show()
...
# build rows (2D list of ints)
rows = []
# Format data to a usable array
...
# magnified preview
#img.resize((width*20, height*20), Image.NEAREST).show()
